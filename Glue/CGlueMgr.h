...
#ifndef WARDEN_GLUE_MGR_HPP
#define WARDEN_GLUE_MGR_HPP
...
public:
    ...
    static void
    SetLoginStateAndResult(LOGIN_STATE state, LOGIN_RESULT result, char const *addrStr, char const *stateStr,
                           char const *resultStr, uint8_t flags);
