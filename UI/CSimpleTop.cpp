...
void CSimpleTop::EnableEvents() {
    ...
    EventRegisterEx(EVENT_ID_KEYDOWN_REPEATING, reinterpret_cast<EVENTHANDLERFUNC>(CSimpleTop::OnKeyDownRepeat), this,
                    1.0);
    EventRegisterEx(EVENT_ID_MOUSEMOVE, reinterpret_cast<EVENTHANDLERFUNC>(CSimpleTop::OnMouseMove), this, 1.0);
    EventRegisterEx(EVENT_ID_MOUSEMOVE_RELATIVE, reinterpret_cast<EVENTHANDLERFUNC>(CSimpleTop::OnMouseMoveRelative),
                    this, 1.0);
...
int32_t CSimpleTop::StartMoveOrResizeFrame(CSimpleFrame *frame, MOVERESIZE_REASON reason, float startx, float starty,
                                           int32_t a6) {
    // TODO
    return 0;
}
